# Spec: Sub-agent Registry

## Capability

Register and configure specialized sub-agents (thread_fetcher, bug_researcher, github_researcher, file_fetcher) that handle domain-specific data fetching tasks delegated by the orchestrator.
